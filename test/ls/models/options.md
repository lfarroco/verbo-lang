...
- path: The directory to list. When the given path is a regular file, the tool lists that single file as one entry even when -R is given. Defaults to the current directory. Defaults to the current directory.
